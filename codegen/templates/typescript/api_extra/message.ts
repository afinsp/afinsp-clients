 ...
 * required to be JSON, and Afinsp will minify the payload before sending the
 ...
 * @param contentType The value to use for the Content-Type header of the webhook sent by Afinsp, overwriting the default of `application/json` if specified
 *
