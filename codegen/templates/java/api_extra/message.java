 ...
 * and Afinsp will minify the payload before sending the webhooks (for example, by removing
 ...
 *
 * @param payload Serialized message payload
 * @param contentType The value to use for the Content-Type header of the webhook sent by Afinsp
 */
